...
const AdminAllResolvedComplaints = () => {
  const complaint = useSelector((state) => state.complaint);
  const resolvedComplaints = [...complaint.closedComplaints];

  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <h2 className="text-3xl font-bold text-[#181c2e] mb-6 border-b-2 border-[#16a34a] pb-2">
        ...
        {resolvedComplaints.map((complaint) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <span className="inline-block px-4 py-1.5 text-sm font-medium rounded-full bg-green-500 text-white shadow-sm">
...
export default AdminAllResolvedComplaints;
